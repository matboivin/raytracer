...
{
	sphere->pos = create_vec3(0.0, 0.0, 0.0);
	sphere->diameter = 0.0;
...
{
	plane->pos = create_vec3(0.0, 0.0, 0.0);
	plane->rot = create_vec3(0.0, 0.0, 0.0);
	plane->color = create_color(0.0, 0.0, 0.0);
}

void	create_square(t_square *square)
{
	square->pos = create_vec3(0.0, 0.0, 0.0);
	square->rot = create_vec3(0.0, 0.0, 0.0);
	square->side = 0.0;
...
{
	cylinder->pos = create_vec3(0.0, 0.0, 0.0);
	cylinder->rot = create_vec3(0.0, 0.0, 0.0);
...
{
	triangle->point1 = create_vec3(0.0, 0.0, 0.0);
	triangle->point2 = create_vec3(0.0, 0.0, 0.0);
	triangle->vec3 = create_vec3(0.0, 0.0, 0.0);
